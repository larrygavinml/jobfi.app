...
function handleSubmit(e) {
    ...
    router.post('/firmrequest', values)
}
  ...
  return (
    <main>
     <section className="pt-20 pb-48">
       ...
       <form>
           <h1 className="text-2xl mb-2">Cert Request</h1>
            <div className="job-info border-b-2 py-2 mb-5">
              <div className="mb-4">
              <label className="block text-gray-700 text-sm mb-2" for="job-title">{auth.user.name }</label>
              </div>

              <div className="mb-4">
              <label className="block text-gray-700 text-sm mb-2" for="job-title">Firm Title</label>
              ...
              <div className="md:flex md:justify-between">
                <div className="w-full md:w-3/12 mb-4 md:mb-0">
                    ...
                    <div className="relative">
                     <select className="block appearance-none w-full bg-white border border-gray-400 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:border-gray-500" name="type"
