...
function UpdateProfilePhoto() {
  ...
  function deletePhoto(e){
    e.preventDefault()
    Inertia.delete('/profilePhotoDelete', {
      preserveScroll: true,
  ...
  function updateProfilePhoto(){
    ...
    Inertia.post('/profilePhotoUpdate', {
      ...
      onSuccess: () => { setReRender(!reRender)}
    })
  }
                ...
                <div className="grid grid-cols-6 gap-6">
                  ...
                  <div className="col-span-6 sm:col-span-4">
                    ...
                    {/* current profile photo */}
                      {
                        !photoPreview &&
                        <div className="mt-2">
                          <img src={auth.user.photo_name ? `/storage/profilePhotos/${auth.user.photo_name}` : useDefaultPhoto(auth.user.name)} alt="" className="object-cover w-20 h-20 rounded-full"/>
                        </div>
                      }
                    ...
                    {/* new profile photo preview */}
                    {
                      photoPreview &&
                      <div className="mt-2">
                        <span className="block w-20 h-20 rounded-full"
