                ...
                <div className="grid grid-cols-6 gap-6">
                  ...
                  <div className="col-span-6 sm:col-span-4">
                    ...
                    <input
                        ...
                        className="block w-full h-10 mt-1 border border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" id="current_password" type="password" autoComplete="current-password"
                      />
                      ...
                      <div className="mt-2"><p className="text-sm text-red-600"></p></div>
                  </div>
                  ...
                  <div className="col-span-6 sm:col-span-4">
                    ...
                    <input
                      ...
                      className="block w-full h-10 mt-1 border border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" id="password" type="password" autoComplete="new-password"/>
                      {errors.updatePassword &&
                        <div className="mt-2 text-sm text-red-500">
                  ...
                  <div className="col-span-6 sm:col-span-4">
                    ...
                    <input
                      ...
                      className="block w-full h-10 mt-1 border border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" id="password_confirmation" type="password" autoComplete="new-password" />
                  </div>
